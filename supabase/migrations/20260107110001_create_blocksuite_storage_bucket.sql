...
--
-- Security: Team members can only access files in their team's folder
...
COMMENT ON POLICY "blocksuite_storage_team_access" ON storage.objects IS
  'Team members can access Yjs documents in their team folder. Path format: {team_id}/{doc_id}.yjs';
