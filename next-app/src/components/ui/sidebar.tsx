...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn("size-7 relative z-[60]", className)}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
